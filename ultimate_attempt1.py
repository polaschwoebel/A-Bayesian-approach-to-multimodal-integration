...
win = visual.Window(
    ...
    monitor=u'myComputer', color=[-1.000,-1.000,-1.000], colorSpace='rgb',
...
for block in blocks:
    ...
    if block == audiotrials:
        ...
        for thisAudiotrial in audiotrials:
            ...
            continueRoutine = True
            # update component parameters for each repeat
            Comparison.setSound(path, secs=-1)
            ...
            while continueRoutine:
                ...
                if t >= 0.0 and beforeStimuli1.status == NOT_STARTED:
                    ...
                    fixationSound.setSound('/Users/admin/Documents/IT&Cognition/Cognitive Science2/experiment-exam/sounds/fixationSound.wav', secs=-1)
        ...
        for thisVisualTrial in visualTrials:
            ...
            while continueRoutine:
                ...
                if t >= 2.0 and VisualDecision.status == NOT_STARTED:
                    # keep track of start time/frame for later
        ...
        for thisCombinedTrial in combinedTrials:
            ...
            while continueRoutine:
                ...
                if t >= 2.0 and CombComparisonResponse.status == NOT_STARTED:
                    # keep track of start time/frame for later
